...
<head>
    ...
    <link rel="stylesheet" href="{{ $s }}/assets/css/amazeui.datatables.min.css" />
...
<body data-type="index">
    ...
    <div class="am-g tpl-g">
        ...
        <header>
            ...
            <div class="am-fl tpl-header-logo">
                <a href="javascript:;"><img src="{{ $s }}/assets/img/logo.png" alt=""></a>
            </div>
            <!-- 右侧内容 -->
                ...
                <div class="row am-cf">
                    <div class="am-u-sm-12 am-u-md-12 am-u-lg-4 widget-margin-bottom-lg ">
                        <div class="tpl-user-card am-text-center widget-body-lg">
                            ...
                            <img class="achievement-image" src="{{ $s }}/assets/img/user07.png" alt="">
    ...
    <script src="{{ $s }}/assets/js/amazeui.min.js"></script>
    <script src="{{ $s }}/assets/js/amazeui.datatables.min.js"></script>
    <script src="{{ $s }}/assets/js/dataTables.responsive.min.js"></script>
